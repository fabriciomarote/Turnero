    ...
    companion object {
        ...
        fun desdeModelo(turno: Turno) =
            TurnoDTO(
                ...
                especialidad = turno.especialidad.toString().lowercase(),
                especialista = turno.especialista,
                hospital = MiniHospitalDTO(turno.hospital!!.id, turno.hospital!!.nombre, turno.hospital!!.direccion, turno.hospital!!.especialidades.map { especialidad -> especialidad.toString().lowercase()}
