...
class TurnoServiceTest {
    ...
    fun `se crea un turno para el hospital Evita Pueblo`() {
        ...
        Assertions.assertEquals(null, turnoRecuperado!!.paciente)
        Assertions.assertEquals(reumatologia, turnoRecuperado!!.especialidad)
        Assertions.assertEquals("Julieta Gomez", turnoRecuperado!!.especialista)
        Assertions.assertEquals("10/10/2022 10:00 hs", turnoRecuperado!!.fechaYHora)
        Assertions.assertEquals(null , turnoRecuperado!!.fechaEmitido)
        Assertions.assertEquals(evitaPueblo.nombre, turnoRecuperado!!.hospital!!.nombre)

        Assertions.assertEquals(turnoEvita, turnoRecuperado)
    }
...
/*
    ...
    fun `se actualiza un turno para el paciente Jorge Perez`() {
        ...
        Assertions.assertEquals("", turnoRecuperado!!.paciente!!.nombreYApellido)
        Assertions.assertEquals(null, turnoRecuperado!!.paciente!!.dni)
        Assertions.assertEquals(null, turnoRecuperado!!.paciente!!.telefono)
        Assertions.assertEquals("", turnoRecuperado!!.paciente!!.email)
        Assertions.assertEquals("10/10/2022 10:00 hs", turnoRecuperado!!.fechaYHora)
        Assertions.assertEquals(reumatologia, turnoRecuperado!!.especialidad)
        Assertions.assertEquals("Julieta Gomez", turnoRecuperado!!.especialista)
        Assertions.assertEquals(evitaPueblo.nombre, turnoRecuperado!!.hospital!!.nombre)
        ...
        Assertions.assertEquals("Jorge Perez", turnoRecuperado!!.nombreYApellidoPaciente)
        Assertions.assertEquals(22345678.toLong(), turnoRecuperado!!.dniPaciente)
        Assertions.assertEquals(1123456789.toLong(), turnoRecuperado!!.telefonoPaciente)
        Assertions.assertEquals("jorgePerez@gmail.com", turnoRecuperado!!.emailPaciente)
    }
    ...
    fun `no se puede actualizar un turno porque el nombre y apellido del paciente es vacio`() {
        ...
        Assertions.assertEquals("", turnoRecuperado!!.nombreYApellidoPaciente)
        try {
...
*/
    ...
    fun `no se puede actualizar un turno porque el dni pasado no cumple con la validacion`() {
        ...
        var turnoId = turno.id!!.toInt()
        var turnoRecuperado = turnoService.recuperar(turnoId)
        Assertions.assertEquals(null, turnoRecuperado!!.dniPaciente)
        try {
    ...
    fun seRecuperanLosTurnosDelHospitalEvitaEnPediatria() {
        var turnos = turnoService.recuperarTurnosDisponiblesPorHospitalYEspecialidad(evitaPueblo.id!!, "pediatria")
    ...
    fun unTurnoSeAsignaAUsuarioDeFormaCorrecta(){
        ...
        var turno1 = turnoService.recuperar(turno1Evita.id!!)
        var turno2 = turnoService.recuperar(turno2Evita.id!!)
        var turno3 = turnoService.recuperar(turno1Wilde.id!!)
    ...
    fun seBorraAlUsuarioDeUnTurnoAsignadoCorrectamente() {
        ...
        turnoService.borrarUsuarioDeTodosSusTurnos(user.id!!)

        var turnoRecuperado1 = turnoService.recuperar(turno1Evita.id!!)
        var turnoRecuperado2 = turnoService.recuperar(turno2Evita.id!!)
        var turnoRecuperado3 = turnoService.recuperar(turno1Wilde.id!!)
