...
class AplicationData {
    ...
    fun prepare() {
        ...
        val turnoEvita1 = Turno("27/12/2022 17:45 hs", pediatria, "Leonardo Sanchez", evitaPueblo)
        val turnoEvita2 = Turno("31/11/2022 12:00 hs", traumatologia, "Manuel Rodriguez", evitaPueblo)
        val turnoEvita3 = Turno("05/12/2022 09:15 hs", urologia, "Pablo Tobias", evitaPueblo)
        val turnoEvita4 = Turno("20/12/2022 10:00 hs", pediatria, "Leonardo Sanchez", evitaPueblo)
        val turnoEvita5 = Turno("27/12/2022 08:15 hs", pediatria, "Leonardo Sanchez", evitaPueblo)
        val turnoEvita6 = Turno("03/01/2023 09:15 hs", traumatologia, "Veronica Manini", evitaPueblo)
        val turnoEvita7 = Turno("03/01/2023 09:45 hs", traumatologia, "Veronica Manini", evitaPueblo)
        val turnoEvita8 = Turno("29/12/2022 14:30 hs", urologia, "Carlos Saenz", evitaPueblo)
        val turnoEvita9 = Turno("29/12/2022 15:00 hs", urologia, "Carlos Saenz", evitaPueblo)
        ...
        val turnoElCruce1 = Turno("04/01/2023     17:45 hs", reumatologia, "Carla Esposito", elCruce)
        val turnoElCruce2 = Turno("05/01/2023     17:45 hs", reumatologia, "Carla Esposito", elCruce)
        val turnoElCruce3 = Turno("15/12/2022     16:00 hs", urologia, "Julian Carrasco", elCruce)
        val turnoElCruce4 = Turno("16/12/2022     16:00 hs", urologia, "Julian Carrasco", elCruce)
        val turnoElCruce5 = Turno("23/12/2022     08:00 hs", traumatologia, "Camila Gutierrez", elCruce)
        val turnoElCruce6 = Turno("23/12/2022     08:30 hs", traumatologia, "Camila Gutierrez", elCruce)
        val turnoElCruce7 = Turno("23/12/2022     09:00 hs", traumatologia, "Camila Gutierrez", elCruce)
        val turnoElCruce8 = Turno("04/01/2023     10:00 hs", nefrologia, "Iris Amato", elCruce)
        val turnoElCruce9 = Turno("04/01/2023     10:30 hs", nefrologia, "Iris Amato", elCruce)
        val turnoElCruce10 = Turno("03/01/2023     09:00 hs", dermatologia, "Luis Dandrea", elCruce)
        val turnoElCruce11 = Turno("03/01/2023     09:30 hs", dermatologia, "Luis Dandrea", elCruce)
        val turnoElCruce12 = Turno("03/01/2023     10:00 hs", dermatologia, "Luis Dandrea", elCruce)
        ...
        val turnoIriarte1 = Turno("15/12/2022     16:00 hs", urologia, "Sandra Vicunia", iriarte)
        val turnoIriarte2 = Turno("16/12/2022     16:00 hs", urologia, "Sandra Vicunia", iriarte)
        val turnoIriarte3 = Turno("23/12/2022     08:00 hs", traumatologia, "Mateo Viña", iriarte)
        val turnoIriarte4 = Turno("23/12/2022     08:30 hs", traumatologia, "Mateo Viña", iriarte)
        val turnoIriarte5 = Turno("23/12/2022     09:00 hs", traumatologia, "Mateo Viña", iriarte)
        val turnoIriarte6 = Turno("04/01/2023     10:00 hs", nefrologia, "Karina Paso", iriarte)
        val turnoIriarte7 = Turno("04/01/2023     10:30 hs", nefrologia, "Karina Paso", iriarte)
        val turnoIriarte8 = Turno("04/01/2023     11:00 hs", nefrologia, "Karina Paso", iriarte)
        val turnoIriarte9 = Turno("03/01/2023     09:30 hs", dermatologia, "Pedro Dandrea", iriarte)
        val turnoIriarte10 = Turno("03/01/2023     10:00 hs", dermatologia, "Pedro Dandrea", iriarte)
        ...
        val turnoMiPueblo1 = Turno("15/12/2022     16:00 hs", urologia, "Hector Lavagna", miPueblo)
        val turnoMiPueblo2 = Turno("16/12/2022     16:00 hs", urologia, "Hector Lavagna", miPueblo)
        val turnoMiPueblo3 = Turno("23/12/2022     08:00 hs", traumatologia, "Maria Castro", miPueblo)
        val turnoMiPueblo4 = Turno("23/12/2022     08:30 hs", traumatologia, "Maria Castro", miPueblo)
        val turnoMiPueblo5 = Turno("23/12/2022     09:00 hs", traumatologia, "Maria Castro", miPueblo)
        val turnoMiPueblo6 = Turno("04/01/2023     10:00 hs", pediatria, "Patricia Marin", miPueblo)
        val turnoMiPueblo7 = Turno("04/01/2023     10:30 hs", pediatria, "Patricia Marin", miPueblo)
        val turnoMiPueblo8 = Turno("04/01/2023     11:00 hs", pediatria, "Patricia Marin", miPueblo)
        ...
        val turnoInterzonal1 = Turno("15/12/2022     16:00 hs", kinesiologia, "Marina Vista", interzonal)
        val turnoInterzonal2 = Turno("16/12/2022     16:00 hs", kinesiologia, "Marina Vista", interzonal)
        val turnoInterzonal3 = Turno("23/12/2022     08:00 hs", traumatologia, "Natalia Guido", interzonal)
        val turnoInterzonal4 = Turno("23/12/2022     08:30 hs", traumatologia, "Natalia Guido", interzonal)
        val turnoInterzonal5 = Turno("23/12/2022     09:00 hs", traumatologia, "Natalia Guido", interzonal)
        val turnoInterzonal6 = Turno("03/01/2023     10:00 hs", cardiologia, "Pedro Pascal", interzonal)
        val turnoInterzonal7 = Turno("03/01/2023     10:30 hs", cardiologia, "Pedro Pascal", interzonal)
        val turnoInterzonal8 = Turno("03/01/2023     11:00 hs", cardiologia, "Pedro Pascal", interzonal)
        val turnoInterzonal9 = Turno("08/01/2023     09:30 hs", dermatologia, "Hugo del Carril", interzonal)
        val turnoInterzonal10 = Turno("08/01/2023     10:00 hs", dermatologia, "Hugo del Carril", interzonal)
        ...
        val turnoGarrahan1 = Turno("26/12/2022     16:00 hs", oncologia, "Isabel Conte", garrahan)
        val turnoGarrahan2 = Turno("26/12/2022     16:30 hs", oncologia, "Isabel Conte", garrahan)
        val turnoGarrahan3 = Turno("26/12/2022     17:00 hs", oncologia, "Isabel Conte", garrahan)
        val turnoGarrahan4 = Turno("23/12/2022     08:30 hs", traumatologia, "Franco Martinez", garrahan)
        val turnoGarrahan5 = Turno("23/12/2022     09:00 hs", traumatologia, "Franco Martinez", garrahan)
        val turnoGarrahan6 = Turno("04/01/2023     10:00 hs", cardiologia, "Maria Belen Cabalieri", garrahan)
        val turnoGarrahan7 = Turno("04/01/2023     10:30 hs", cardiologia, "Maria Belen Cabalieri", garrahan)
        val turnoGarrahan8 = Turno("04/01/2023     11:00 hs", cardiologia, "Maria Belen Cabalieri", garrahan)
        val turnoGarrahan9 = Turno("08/01/2023     09:30 hs", dermatologia, "Joaquin Leal", garrahan)
        val turnoGarrahan10 = Turno("08/01/2023     10:00 hs", dermatologia, "Joaquin Leal", garrahan)
        ...
        val turnoItalianoCABA1 = Turno("26/12/2022     16:00 hs", urologia, "Lucas Gomez", italianoCABA)
        val turnoItalianoCABA2 = Turno("26/12/2022     16:30 hs", urologia, "Lucas Gomez", italianoCABA)
        val turnoItalianoCABA3 = Turno("26/12/2022     17:00 hs", urologia, "Lucas Gomez", italianoCABA)
        val turnoItalianoCABA4 = Turno("23/12/2022     08:30 hs", traumatologia, "Fernanda Davila", italianoCABA)
        val turnoItalianoCABA5 = Turno("23/12/2022     09:00 hs", traumatologia, "Fernanda Davila", italianoCABA)
        val turnoItalianoCABA6 = Turno("04/01/2023     10:00 hs", pediatria, "Hernan Iurisevich", italianoCABA)
        val turnoItalianoCABA7 = Turno("04/01/2023     10:30 hs", pediatria, "Hernan Iurisevich", italianoCABA)
        ...
        val turnoPirovano1 = Turno("26/12/2022     16:00 hs", oncologia, "Candela Bercovich", pirovano)
        val turnoPirovano2 = Turno("26/12/2022     16:30 hs", oncologia, "Candela Bercovich", pirovano)
        val turnoPirovano3 = Turno("26/12/2022     17:00 hs", oncologia, "Candela Bercovich", pirovano)
        val turnoPirovano4 = Turno("23/12/2022     08:30 hs", traumatologia, "Claudia Peruggino", pirovano)
        val turnoPirovano5 = Turno("23/12/2022     09:00 hs", traumatologia, "Claudia Peruggino", pirovano)
        val turnoPirovano6 = Turno("04/01/2023     10:00 hs", reumatologia, "Diego Taibo", pirovano)
        val turnoPirovano7 = Turno("04/01/2023     10:30 hs", reumatologia, "Diego Taibo", pirovano)
        val turnoPirovano8 = Turno("04/01/2023     11:00 hs", reumatologia, "Diego Taibo", pirovano)
        ...
        val turnoSanMartin1 = Turno("15/12/2022     16:00 hs", dermatologia, "Federico Luna", sanMartin)
        val turnoSanMartin2 = Turno("16/12/2022     16:00 hs", dermatologia, "Federico Luna", sanMartin)
        val turnoSanMartin3 = Turno("23/12/2022     08:00 hs", traumatologia, "Maria Cosnard", sanMartin)
        val turnoSanMartin4 = Turno("23/12/2022     08:30 hs", traumatologia, "Maria Cosnard", sanMartin)
        val turnoSanMartin5 = Turno("23/12/2022     09:00 hs", traumatologia, "Maria Cosnard", sanMartin)
        val turnoSanMartin6 = Turno("04/01/2023     10:00 hs", pediatria, "Quimey Ramos", sanMartin)
        val turnoSanMartin7 = Turno("04/01/2023     10:30 hs", pediatria, "Quimey Ramos", sanMartin)
        val turnoSanMartin8 = Turno("03/01/2023     13:00 hs", cardiologia, "Julio Avendaño", sanMartin)
        ...
        val turnoSanRoque1 = Turno("26/12/2022     16:00 hs", pediatria, "Alejandro Mamani", sanRoque)
        val turnoSanRoque2 = Turno("26/12/2022     16:30 hs", pediatria, "Alejandro Mamani", sanRoque)
        val turnoSanRoque3 = Turno("23/12/2022     14:00 hs", traumatologia, "Diana Sacayan", sanRoque)
        val turnoSanRoque4 = Turno("23/12/2022     14:30 hs", traumatologia, "Diana Sacayan", sanRoque)
        val turnoSanRoque5 = Turno("23/12/2022     15:00 hs", traumatologia, "Diana Sacayan", sanRoque)
        val turnoSanRoque6 = Turno("04/01/2023     10:00 hs", kinesiologia, "Victor Kesler", sanRoque)
        val turnoSanRoque7 = Turno("04/01/2023     10:30 hs", kinesiologia, "Victor Kesler", sanRoque)
        ...
        val turnoSantamarina1 = Turno("15/12/2022     16:00 hs", dermatologia, "Julieta Federici", santamarina)
        val turnoSantamarina2 = Turno("15/12/2022     16:30 hs", dermatologia, "Julieta Federici", santamarina)
        val turnoSantamarina3 = Turno("23/12/2022     08:00 hs", reumatologia, "Hilda Gomez", santamarina)
        val turnoSantamarina4 = Turno("23/12/2022     08:30 hs", reumatologia, "Hilda Gomez", santamarina)
        val turnoSantamarina5 = Turno("23/12/2022     09:00 hs", reumatologia, "Hilda Gomez", santamarina)
        val turnoSantamarina6 = Turno("04/01/2023     10:00 hs", pediatria, "Lohana Berkins", santamarina)
        val turnoSantamarina7 = Turno("04/01/2023     10:30 hs", pediatria, "Lohana Berkins", santamarina)
        val turnoSantamarina8 = Turno("07/01/2023     15:00 hs", oncologia, "Tomas Salcedo", santamarina)
        val turnoSantamarina9 = Turno("07/01/2023     15:30 hs", oncologia, "Tomas Salcedo", santamarina)
        val turnoSantamarina10 = Turno("07/01/2023     16:00 hs", oncologia, "Tomas Salcedo", santamarina)
        val turnoSantamarina11 = Turno("07/01/2023     16:30 hs", oncologia, "Tomas Salcedo", santamarina)
        ...
        val turnoBocalandro1 = Turno("04/01/2023     17:45 hs", dermatologia, "Tamara Tenenbaum", bocalandro)
        val turnoBocalandro2 = Turno("05/01/2023     17:45 hs", dermatologia, "Tamara Tenenbaum", bocalandro)
        val turnoBocalandro3 = Turno("23/12/2022     08:00 hs", traumatologia, "Yvone de Lucia", bocalandro)
        val turnoBocalandro4 = Turno("23/12/2022     08:30 hs", traumatologia, "Yvone de Lucia", bocalandro)
        val turnoBocalandro5 = Turno("23/12/2022     09:00 hs", traumatologia, "Yvone de Lucia", bocalandro)
        val turnoBocalandro6 = Turno("04/01/2023     10:00 hs", nefrologia, "Joel Villagran", bocalandro)
        val turnoBocalandro7 = Turno("04/01/2023     10:30 hs", nefrologia, "Joel Villagran", bocalandro)
        ...
        val turnoItalianoLP1 = Turno("26/12/2022     16:00 hs", urologia, "Osvaldo Yutay", italianoLP)
        val turnoItalianoLP2 = Turno("26/12/2022     16:30 hs", urologia, "Osvaldo Yutay", italianoLP)
        val turnoItalianoLP3 = Turno("26/12/2022     17:00 hs", urologia, "Osvaldo Yutay", italianoLP)
        val turnoItalianoLP4 = Turno("23/12/2022     08:30 hs", cardiologia, "Cristina Sobisch", italianoLP)
        val turnoItalianoLP5 = Turno("23/12/2022     09:00 hs", cardiologia, "Cristina Sobisch", italianoLP)
        val turnoItalianoLP6 = Turno("23/12/2022     10:00 hs", cardiologia, "Cristina Sobisch", italianoLP)
        val turnoItalianoLP7 = Turno("04/01/2023     10:30 hs", pediatria, "Carmen Hernandez", italianoLP)
